---
title: 'Cuánto cuesta alquilar un consultorio en Montevideo (2026)'
titleSeo: 'Cuánto cuesta alquilar un consultorio en Montevideo · Precios 2026'
...
**Alquilar un consultorio por hora en Montevideo cuesta entre $200 y $400 pesos uruguayos**, que es la franja donde está la mayor parte de la oferta (hay opciones más básicas desde $90 con carnés de horas prepagas). **Un consultorio mensual, sumando alquiler, gastos comunes, servicios y limpieza, difícilmente baje de $25.000 al mes**, más garantía y mobiliario para arrancar. En [Espacio 1010](/precios) —Gaboto 1010, entre Palermo y Parque Rodó— la hora sale **$350 con todo incluido**, y baja a $315 desde 20 horas mensuales y a $280 desde 40.

Abajo está el desglose: los rangos del mercado a agosto de 2026, la cuenta completa del consultorio propio, y cómo saber cuál te conviene según tus horas reales de atención.

## Las dos formas de alquilar un consultorio

En Montevideo hoy conviven dos modelos:

- **Alquiler mensual tradicional**: alquilás un consultorio (o un apartamento que adaptás) y lo pagás todos los meses, lo uses o no.
- **Alquiler por hora**: pagás solo las horas en que atendés, en un espacio compartido con otros profesionales.

El costo de cada uno se compone distinto, así que vamos por partes.

## ¿Cuánto cuesta un consultorio por hora en Montevideo?

En agosto de 2026, el mercado de consultorios por hora en Montevideo se mueve aproximadamente en estos rangos (pesos uruguayos):

| Franja | Precio por hora | Qué suele ofrecer |
| --- | --- | --- |
...
Si preferís un espacio propio, la cuenta tiene más renglones de los que parece:

| Concepto | Costo mensual aproximado |
| --- | --- |
| Alquiler (consultorio o apto chico, zona céntrica) | $18.000 – $30.000+ |
| Gastos comunes | $2.000 – $6.000 |
| Luz + internet | $2.000 – $4.000 |
| Limpieza | $2.000 – $5.000 |
| **Total mensual estimado** | **$25.000 – $45.000** |

Y a eso sumale los costos de entrada, por una sola vez pero nada menores: **garantía de alquiler, mes de depósito, mobiliario** (sillón, butacas, escritorio, aire acondicionado si no tiene) y pintura o adecuación del espacio. Es fácil que el arranque supere los $100.000 antes de atender a la primera persona.

Los rangos varían según zona y estado del inmueble — tomalos como orden de magnitud, no como tasación. En la [guía de zonas para atender en Montevideo](/guias/donde-atender-en-montevideo-guia-de-zonas) profundizamos en las diferencias por barrio.
...
| --- | --- | --- |
| 10 h | $3.500 | $25.000+ |
| 20 h | $6.300 (con 10% off) | $25.000+ |
| 40 h | $11.200 (con 20% off) | $25.000+ |
| 60 h | $16.800 (con 20% off) | $25.000+ |
| 80 h | $22.400 (con 20% off) | $25.000+ |

La conclusión es bastante clara: **hasta unas 80 horas mensuales —unas 20 horas por semana— el alquiler por hora es más barato que el consultorio propio**, y eso sin contar la inversión inicial ni el riesgo de los meses flojos (licencia, enfermedad, verano). Después de ese volumen, la conversación cambia — la desarrollamos en detalle en [¿consultorio por hora o alquiler mensual?](/guias/consultorio-por-hora-o-alquiler-mensual).

## Lo que no aparece en ninguna tabla

Dos costos que no se ven en la comparación de números:
...
- [¿Consultorio por hora o alquiler mensual? La cuenta completa](/guias/consultorio-por-hora-o-alquiler-mensual)
- [Cómo elegir un consultorio por hora (checklist)](/guias/como-elegir-un-consultorio-por-hora)
- [Precios de Espacio 1010](/precios) — $350/h todo incluido, primera hora gratis al registrarte
